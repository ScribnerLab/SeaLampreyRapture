...
dir.create("./analysis/simulations/Create simulations/Output/")
dir.create("./analysis/simulations/Create simulations/Output/sims")
dir.create("./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100")
dir.create("./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/breeding_matrices")
dir.create("./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/alf_dist")
dir.create("./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/colony_dat")
dir.create("./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/input_par")

#making some basic folder names
#to be used later when saving files to specific output folders
sim.folder <- "./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/"
mat.folder <- "./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/breeding_matrices/"
alf.folder <- "./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/alf_dist/"
dat.folder <- "./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/colony_dat/"
par.folder <- "./analysis/simulations/Create simulations/Output/sims/Npar10_Nloci100/input_par/"
